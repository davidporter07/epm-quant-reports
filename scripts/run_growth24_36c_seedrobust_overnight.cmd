@echo off
cd /d D:\fund_monitor
set OUT=data\experiment\historical_blind_rank_head\growth24_36c_8e_date_excess_topmono_seedrobust_2seed_overnight_stdout.log
set ERR=data\experiment\historical_blind_rank_head\growth24_36c_8e_date_excess_topmono_seedrobust_2seed_overnight_stderr.log
...
D:\fund_monitor\.venv\Scripts\python.exe dl_rank_head_historical_blind_loop.py ^
  ...
  --output-stem growth24_36c_8e_date_excess_topmono_seedrobust_2seed_overnight ^
  --output data/experiment/historical_blind_rank_head/growth24_36c_8e_date_excess_topmono_seedrobust_2seed_overnight_shadow_log.parquet ^
  --csv-output data/experiment/historical_blind_rank_head/growth24_36c_8e_date_excess_topmono_seedrobust_2seed_overnight_shadow_log.csv ^
  --summary-output data/experiment/historical_blind_rank_head/growth24_36c_8e_date_excess_topmono_seedrobust_2seed_overnight_summary.json >> "%OUT%" 2>> "%ERR%"
