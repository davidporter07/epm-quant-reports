...
$features = @(
  ...
  "SectorRel_atr_percentile",
  "Sector_hv_percentile",
  "SectorRel_hv_percentile"
) -join ","

& "D:\fund_monitor\.venv\Scripts\python.exe" `
  "dl_rank_head_historical_blind_loop.py" `
  --panel "data/experiment/dl_research_panels/research_growth_24_price_earnings_av_sector_panel.parquet" `
  ...
  --output-stem "growth24_3c_3e_feature_probe_sector_earnings" `
  --output "data/experiment/historical_blind_rank_head/growth24_3c_3e_feature_probe_sector_earnings_shadow_log.parquet" `
  --csv-output "data/experiment/historical_blind_rank_head/growth24_3c_3e_feature_probe_sector_earnings_shadow_log.csv" `
  --summary-output "data/experiment/historical_blind_rank_head/growth24_3c_3e_feature_probe_sector_earnings_summary.json"
