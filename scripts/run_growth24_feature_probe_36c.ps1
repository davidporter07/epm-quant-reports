...
& "D:\fund_monitor\.venv\Scripts\python.exe" `
  ...
  --output-stem "growth24_36c_8e_feature_probe_rsi_ma_volume_earnings_seedrobust_2seed" `
  --output "data/experiment/historical_blind_rank_head/growth24_36c_8e_feature_probe_rsi_ma_volume_earnings_seedrobust_2seed_shadow_log.parquet" `
  --csv-output "data/experiment/historical_blind_rank_head/growth24_36c_8e_feature_probe_rsi_ma_volume_earnings_seedrobust_2seed_shadow_log.csv" `
  --summary-output "data/experiment/historical_blind_rank_head/growth24_36c_8e_feature_probe_rsi_ma_volume_earnings_seedrobust_2seed_summary.json"
