...
& "D:\fund_monitor\.venv\Scripts\python.exe" `
  ...
  --output-stem "growth24_3c_3e_feature_probe_rsi_ma_volume_earnings" `
  --output "data/experiment/historical_blind_rank_head/growth24_3c_3e_feature_probe_rsi_ma_volume_earnings_shadow_log.parquet" `
  --csv-output "data/experiment/historical_blind_rank_head/growth24_3c_3e_feature_probe_rsi_ma_volume_earnings_shadow_log.csv" `
  --summary-output "data/experiment/historical_blind_rank_head/growth24_3c_3e_feature_probe_rsi_ma_volume_earnings_summary.json"
